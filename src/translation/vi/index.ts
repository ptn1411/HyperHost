...
export const tooltipOpenFolder = "Mở thư mục: %%path%%";
export const tooltipOpenTerminal = "Mở terminal tại thư mục dự án";
export const tooltipDocker = "Quản lý docker compose của dự án";
export const tooltipAiSkill = "Cài AI skill (Claude, Gemini, Codex) vào dự án";
export const tooltipRunCommand = "Chạy: %%command%%";
...
export const tunnelDnsHint = "⚠ Nếu không mở được, hãy đổi DNS sang 1.1.1.1 hoặc bật Secure DNS";
export const tunnelError = "Tunnel [%%domain%%]: %%error%%";
export const aiSkillsInstalled = "Đã cài AI skills vào %%path%%";
export const aiSkillsFailed = "Một số skills bị lỗi: %%failed%%";
...
export const editorPlaceholderProjectPath = "Thư mục dự án (tùy chọn - để mở nhanh folder / terminal / docker)";
export const editorPlaceholderRunCommand = "Lệnh Run dự án (tùy chọn - ví dụ: npm run dev, cargo run...)";
...
export const editorSubtext = "Chế độ chỉnh sửa Nginx Config trực tiếp. Hỗ trợ biến $DOMAIN, $UPSTREAM, $CERT_PATH, $KEY_PATH.";
export const editorImportTooltip = "Dán nội dung .conf từ prod để tự động convert sang dev";
export const editorValidateTooltip = "Kiểm tra cú pháp nginx với nginx -t";
export const editorExportTooltip = "Tạo file nginx snippet trong thư mục dự án (sẵn sàng cho prod deploy)";
export const editorCancelTooltip = "Hủy chỉnh sửa";
export const editorUpdateTooltip = "Cập nhật cấu hình Nginx cho domain";
export const editorCreateTooltip = "Tạo domain mới với cấu hình này";
export const editorClearTooltip = "Xóa trắng toàn bộ Nginx config";
export const editorClearConfirm = "Xóa trắng toàn bộ Nginx config?";
export const editorValidateEmpty = "Config trống — không có gì để validate.";
export const editorValidateSyntaxOk = "nginx -t: cú pháp hợp lệ (syntax OK)";
export const editorImportValidateOk = "Import thành công: nginx -t hợp lệ ✓";
export const editorImportValidateFail = "Import: nginx -t thất bại\n%%error%%";
...
export const editorExportPlaceholderProdDomain = "Tên miền Prod (ví dụ: myapp.com)";
export const editorExportPlaceholderProdUpstream = "Upstream Prod (ví dụ: http://127.0.0.1:8080 hoặc unix:/tmp/app.sock)";
export const editorExportBtn = "Xuất file";
export const editorExportWriting = "Đang ghi…";
export const editorExportSaved = "File snippet đã được lưu vào: %%path%%";
...
export const quickStartProjectCreateDomainTooltip = "Tạo domain cho dự án này";
export const quickStartProjectOpenTerminalTooltip = "Mở terminal tại thư mục dự án";
export const quickStartProjectRunCommandTooltip = "Mở terminal và chạy: %%command%%";
export const quickStartProjectCreateTooltip = "Tạo domain";
...
export const namedTunnelLoginSuccess = "Đăng nhập Cloudflare thành công";
...
export const namedTunnelProvisionSuccess = "Tunnel \"%%name%%\" đã được tạo trên Cloudflare";
...
export const dockerClose = "Đóng (Esc)";
export const dockerStatusTitle = "Trạng thái Docker";
export const dockerCli = "Docker CLI";
export const dockerDaemon = "Docker Daemon";
export const dockerNotInstalled = "Chưa cài / Không tìm thấy";
export const dockerRunning = "Đang chạy";
export const dockerStopped = "Chưa chạy";
export const dockerRefresh = "Làm mới";
export const dockerChecking = "Đang kiểm tra...";
export const dockerFilesTitle = "File Compose trong dự án";
export const dockerNoFiles = "Không tìm thấy file docker-compose*.yml nào trong thư mục dự án.";
export const dockerCreateWithAi = "Tạo Compose với AI";
export const dockerServices = "Dịch vụ (%%count%%):";
export const dockerNoServicesRunning = "Chưa có service nào đang chạy.";
export const dockerBtnRun = "Chạy (up -d)";
export const dockerBtnStop = "Dừng (down)";
export const dockerBtnRestart = "Restart";
export const dockerBtnLogs = "Logs";
export const dockerOutput = "Output";
export const dockerClear = "Xóa";
export const dockerPromptTitle = "Tạo Prompt Docker Compose cho AI";
export const dockerPromptDesc = "Chọn các database / services dự án cần dùng:";
export const dockerPromptPort = "Port:";
export const dockerPromptPass = "Pass:";
export const dockerPromptExtraReq = "Yêu cầu thêm (tùy chọn):";
export const dockerPromptExtraPlaceholder = "Ví dụ: thêm phpMyAdmin cho MySQL, tạo network riêng, mount volume persistent...";
export const dockerPromptGenerated = "Prompt đã tạo cho AI (Cursor, Claude, Copilot, ChatGPT...):";
export const dockerPromptCopy = "Sao chép Prompt";
export const dockerPromptCopied = "Đã sao chép!";
export const dockerPasteTitle = "Lưu file YAML vào dự án";
export const dockerPasteFileName = "Tên file";
export const dockerPasteContent = "Nội dung YAML:";
export const dockerPastePlaceholder = "Dán nội dung docker-compose.yml mà AI đã sinh vào đây...";
export const dockerPasteSave = "Lưu file vào dự án";
export const dockerPasteSaving = "Đang lưu...";
export const dockerSaveValidation = "Cần điền tên file và nội dung YAML.";
export const dockerSaveOverwriteConfirm = "File %%fileName%% đã tồn tại. Ghi đè?";
export const dockerSaveSuccess = "Đã lưu: %%path%%";
